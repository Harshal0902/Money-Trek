    ...
    <div className="chatbot">
      <ThemeProvider theme={theme}>
        <ChatBot
          ...
          botAvatar={"https://www.pngitem.com/pimgs/m/129-1298996_streamlabs-chatbot-logo-hd-png-download.png"}
          avatarStyle={{ borderRadius: "100%" }}
          floating={true}
          floatingIcon={
            <img
              src={"https://www.pngitem.com/pimgs/m/129-1298996_streamlabs-chatbot-logo-hd-png-download.png"}
              style={{ width: "70%" }}
              alt="chatBot icon"
            />
          }
